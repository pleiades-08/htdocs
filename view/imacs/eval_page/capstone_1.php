                ...
                <div id="feedbackMessage"></div>
                    <div class="evalcon">
                        ...
                        <button class="accordion chapter" type="button">
                            <h3>Chapter 1</h3> <span class="chevron">&#x25BC;</span>
                        </button>
                        ...
                        <button class="accordion chapter" type="button">
                            <h3>Chapter 2</h3> <span class="chevron">&#x25BC;</span>
                        </button>
                        <div class="panel chapter-content" >
                            <button class="accordion nested" type="button"><h3>Comments</h3> <span class="chevron">&#x25BC;</span></button>
                            <div class="nested-panel">
                        ...
                        <button class="accordion chapter" type="button">
                            <h3>Chapter 3</h3> <span class="chevron">&#x25BC;</span>
                        </button>
                        <div class="panel chapter-content" >
                            <button class="accordion nested" type="button"><h3>Comments</h3> <span class="chevron">&#x25BC;</span></button>
                            <div class="nested-panel">
                        ...
                        <input type="hidden" name="chapter_no" id="chapter_no" value="1">
                        <input type="hidden" name="chapter_no" id="chapter_no" value="2">
                        <input type="hidden" name="chapter_no" id="chapter_no" value="3">
                    </div>
                ...
                <div class="evalcon evalcon2">
                    ...
                    <div id="actual-comment-history" style="display: none;">
                        ...
                        <select id="history">
                            ...
                            <option value="Chapter 2">Chapter 3</option>
                        </select>

                        <!-- Each group wrapped in a container -->
                        <div class="chapter-section" data-chapter="Proposal" style="display:none;">
                            <table>
                                <tr>
                                    <th>Comments:</th>
                                    <td id="commentsTd_Proposal" class="loading">Select an evaluation type to view details.</td>
                                </tr>
                            </table>
                            <table>
                                <tr>
                                    <th>Suggestions:</th>
                                    <td id="suggestionsTd_Proposal" class="loading">Select an evaluation type to view details.</td>
                                </tr>
                            </table>
                            <table>
                                <tr>
                                    <th>Revisions:</th>
                                    <td id="revisionsTd_Proposal" class="loading">Select an evaluation type to view details.</td>
                                </tr>
                            </table>
                            <table>
                                <tr>
                                    <th>Status:</th>
                                    <td id="remarksTd_Proposal" class="loading">Select an evaluation type to view details.</td>
                                </tr>
                            </table>
                        </div>

                        <div class="chapter-section" data-chapter="Capstone 1" style="display:none;">
                            <table>
                                <tr>
                                    <th>Comments:</th>
                                    <td id="commentsTd_Proposal" class="loading">Select an evaluation type to view details.</td>
                        ...
                        <div class="chapter-section" data-chapter="Capstone 2" style="display:none;">
                            <table>
                                <tr>
                                    <th>Comments:</th>
                                    <td id="commentsTd_Proposal" class="loading">Select an evaluation type to view details.</td>
                        ...
                        document.getElementById('history').addEventListener('change', function() {
                            ...
                            // Show the selected one if not empty
                            if (selected) {
                                const target = document.querySelector(`.chapter-section[data-chapter="${selected}"]`);
                                if (target) {
