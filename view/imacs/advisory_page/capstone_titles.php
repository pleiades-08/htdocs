                    ...
                    <?php if ($documents): ?>
                        <?php foreach ($documents as $row): ?>
                            <tr>
                                ...
                                <td><?= $row['status'] ?></td>
                                <td>
                                <a href="../../controllers/fetchLocationController.php?&progress=<?= urlencode($row['capstone_type']) ?>&file=<?= htmlspecialchars(urlencode($row['file_name'])) ?>&id=<?= urldecode($fetch['user_id'])?> &name=<?= urldecode($row['document_name'])?>" class="btn btn-sm btn-info">
                                    View
                                </a></td>
                            </td>
                            </tr>
