...
<body>
    ...
    <?php include $_SERVER['DOCUMENT_ROOT'] . './assets/components/asidebar.php'; ?>
    ...
    <div class="content-page">
        ...
        <table class="table table-striped table-hover mb-4 data_table" style="width: 100%;" id="activeTable">
            ...
            <thead>
                <tr>
                    <th data-column="user_id" data-order="desc" data-label="ID" style="width: 80px;">ID ▼</th>
                    <th data-column="fullname" data-order="desc" data-label="Name" style="width: 200px;">Name ▼</th>
                    <th data-column="user_type" data-order="desc" data-label="Type" style="width: 100px;">Type ▼</th>
                    <th data-column="dept" data-order="desc" data-label="Department" style="width: 150px;">Department ▼</th>
